Introduction
The script run_analysis.R performs the 5 steps described in the Data Cleaning course project's definition.
...
And finally, we generate a new dataset with all the average measures for each subject and activity type (30 subjects * 6 activities = 180 rows). The output file is called averages_data.txt, and uploaded to this repository.
